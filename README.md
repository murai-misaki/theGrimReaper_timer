...
##h2解決方法
- 座りすぎによるリスクを伝える
- 1日ごとの、座っている時間と1時間座り続けたことで縮んだ寿命を記録し、グラフ化して可視化できるようにする
...
- ログインユーザー
    ...
    - ユーザーがマイページで直近1週間の1日ごとの1時間座り続けたことで縮んだ寿命を折れ線グラフで確認できる
...
- 立ち上がらずに座り続けて1時間が経過すると、その日の座りすぎによって縮んだ寿命がリアルタイムで、タイマー使用中に表示される
- 1日ごとの、座っている時間と1時間座り続けたことで縮んだ寿命を記録し、グラフ化して可視化できる
